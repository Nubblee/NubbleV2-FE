...
const languageOptions = ['Java', 'Python', 'Javascript', 'C', 'C++', 'Kotlin', 'Rust', 'Swift']
      ...
      <div className='flex w-full gap-10'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='w-[70px]'>
            <Input id='personnel' placeholder='0' className='py-1 border-gray-light flex-grow' />
          </div>
        </div>
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='w-[140px]'>
            <Input id='deadline' type='date' className='py-1 border-gray-light flex-grow' />
          </div>
        </div>
      </div>
    </div>
